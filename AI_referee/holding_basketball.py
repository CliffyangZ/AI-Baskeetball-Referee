...
class BallHoldingDetector:
    def __init__(self):
        ...
        self.pose_model = YOLO("models/pt_models/yolov8s-pose.pt")
        self.ball_model = YOLO("models/pt_models/basketballModel.pt")

        # Open the webcam
        self.cap = cv2.VideoCapture("data/video/Travel.mov")
