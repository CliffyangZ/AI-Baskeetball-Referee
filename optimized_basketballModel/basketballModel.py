...
class BasketballTracker:
    ...
    """
    def __init__(self, model_path='../pt_models/basketballModel.pt'):
        """
    ...
    def track_video(self, video_path, output_path=None):
        ...
        try:
            # Use predict instead of track to avoid compatibility issues
    ...
    def track_realtime(self, source=0, display_scale=1.0):
        ...
        cap = cv2.VideoCapture("../data/video/o_dribbing.mov")
